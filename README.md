...
This image is based on the official JBoss Image located at https://github.com/keycloak/keycloak-containers and is modified 
to be be based on Ubuntu and Open JDK 11 so that it is more portable and can be adapted into an environment that is air
gapped and has it's own hardened Ubuntu based images and package repositories.
